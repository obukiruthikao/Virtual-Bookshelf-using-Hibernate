<%-- 
    Document   : dashboard
    Created on : Apr 22, 2020, 10:48:30 AM
    Author     : Obu
--%>
...
<div class="wrapper">
    ...
    <form action="ListBooks" method="post"> <input type="submit" class="submit" value="Update a book"></form>
    <form action="DeleteBook" method="post"> <input type="submit" class="submit" value="Delete a book"></form>
