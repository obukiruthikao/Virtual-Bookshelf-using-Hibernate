...
"");
            ...
            out.println("<form action='UpdatedBook' method='POST'>");
            out.println("<input type='text' class='name' name='book' value='"+book+"' readonly/>");
            out.println("<input type='text' class='name' name='author' value='"+author+"' required/>");
            out.println("<input type='text' class='name' name='pages' value='"+pages+"' required/>");
            out.println("<input type='text' class='name' name='pageno' value='"+pageno+"' required/>");
            out.println("<input type='text' class='name' name='category' value='"+category+"' required/>");
            out.println("<input type='submit' class='submit' value='Update Book'></form>");
