 ...
 * @author Obu
 */
@WebServlet(name = "ReadBooks", urlPatterns = {"/ReadBooks"})
public class ReadBooks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql = "SELECT * FROM book WHERE category='read' AND user='"+user+"'";
...
"  color: white;\n" +
"}\n" +
"</style></head><body><center><table><tr><th>Book</th><th>Author</th><th>Pages</th><th>Pages Read</th></tr>");
